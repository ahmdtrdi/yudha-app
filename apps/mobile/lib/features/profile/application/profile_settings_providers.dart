...
final Provider<ProfileSettingsStorage> profileSettingsStorageProvider =
    Provider<ProfileSettingsStorage>(
      (Ref ref) => const SharedPreferencesProfileSettingsStorage(),
    );
...
profileSettingsProvider =
    StateNotifierProvider<ProfileSettingsController, ProfileSettings>(
      (Ref ref) => ProfileSettingsController(
        storage: ref.watch(profileSettingsStorageProvider),
      ),
    );
