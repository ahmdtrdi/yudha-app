...
abstract final class AppColors {
  ...
  static const Color textStrong = Color(0xFF132547);
  static const Color textMuted = Color(0xFF5E6D86);

  // Backward-compatible aliases used by earlier baseline files.
  static const Color primary = warriorNavy;
  static const Color secondary = levelUpTeal;
}
